...
export default function ForgotPassword() {
  ...
  function resetEmail(event) {
    ...
    if (
      document.querySelectorAll(".forgotPasswordContainer>input:invalid").length
    ) {
      return;
    }
  ...
  return (
    <form className="forgotPasswordContainer">
      ...
      />
      <p3 style={warning.style} className="error-message">
        {warning.value}
      </p3>
      <button className="sign_button" onClick={resetEmail}>
        Reset Password
      </button>
    </form>
  );
